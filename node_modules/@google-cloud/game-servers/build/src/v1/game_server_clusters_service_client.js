...
class GameServerClustersServiceClient {
    ...
    constructor(opts) {
        ...
        const createGameServerClusterResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1.GameServerCluster');
        const createGameServerClusterMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1.OperationMetadata');
        const deleteGameServerClusterResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteGameServerClusterMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1.OperationMetadata');
        const updateGameServerClusterResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1.GameServerCluster');
        const updateGameServerClusterMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.gaming.v1.GameServerClustersService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.gameServerClustersServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.gaming.v1.GameServerClustersService')
