...
class GameServerConfigsServiceClient {
    ...
    constructor(opts) {
        ...
        const createGameServerConfigResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1.GameServerConfig');
        const createGameServerConfigMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1.OperationMetadata');
        const deleteGameServerConfigResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteGameServerConfigMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.gaming.v1.GameServerConfigsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.gameServerConfigsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.gaming.v1.GameServerConfigsService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.gaming.v1.GameServerConfigsService, this._opts);
