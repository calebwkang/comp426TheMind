...
class GameServerDeploymentsServiceClient {
    ...
    constructor(opts) {
        ...
        const createGameServerDeploymentResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1.GameServerDeployment');
        const createGameServerDeploymentMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1.OperationMetadata');
        const deleteGameServerDeploymentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteGameServerDeploymentMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1.OperationMetadata');
        const updateGameServerDeploymentResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1.GameServerDeployment');
        const updateGameServerDeploymentMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1.OperationMetadata');
        const updateGameServerDeploymentRolloutResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1.GameServerDeployment');
        const updateGameServerDeploymentRolloutMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.gaming.v1.GameServerDeploymentsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.gameServerDeploymentsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.gaming.v1.GameServerDeploymentsService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.gaming.v1
