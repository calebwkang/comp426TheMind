...
class RealmsServiceClient {
    ...
    constructor(opts) {
        ...
        const createRealmResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1.Realm');
        const createRealmMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1.OperationMetadata');
        const deleteRealmResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteRealmMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1.OperationMetadata');
        const updateRealmResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1.Realm');
        const updateRealmMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1.OperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.gaming.v1.RealmsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.realmsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.gaming.v1.RealmsService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.gaming.v1.RealmsService, this._opts);
