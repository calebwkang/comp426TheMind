...
exports.GameServerClustersServiceClient = void 0;
const gax = require("google-gax");
const path = require("path");
const gapicConfig = require("./game_server_clusters_service_client_config.json");
...
class GameServerClustersServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listGameServerClusters: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'gameServerClusters'),
        };
        ...
        const createGameServerClusterResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.GameServerCluster');
        const createGameServerClusterMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.OperationMetadata');
        const deleteGameServerClusterResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteGameServerClusterMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.OperationMetadata');
        const updateGameServerClusterResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.GameServerCluster');
        const updateGameServerClusterMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.OperationMetadata');
        this.descriptors.longrunning = {
            createGameServerCluster: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createGameServerClusterResponse.decode.bind(createGameServerClusterResponse), createGameServerClusterMetadata.decode.bind(createGameServerClusterMetadata)),
            deleteGameServerCluster: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteGameServerClusterResponse.decode.bind(deleteGameServerClusterResponse), deleteGameServerClusterMetadata.decode.bind(deleteGameServerClusterMetadata)),
            updateGameServerCluster: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateGameServerClusterResponse.decode.bind(updateGameServerClusterResponse), updateGameServerClusterMetadata.decode.bind(updateGameServerClusterMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.gaming.v1beta.GameServerClustersService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.gameServerClustersServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.gaming.v1beta.GameServerClustersService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.gaming.v1beta
                    .GameServerClustersService, this._opts);
        ...
        for (const methodName of gameServerClustersServiceStubMethods) {
            const callPromise = this.gameServerClustersServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    getGameServerCluster(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    previewCreateGameServerCluster(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    previewDeleteGameServerCluster(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    previewUpdateGameServerCluster(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    createGameServerCluster(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkCreateGameServerClusterProgress(name) {
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    deleteGameServerCluster(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkDeleteGameServerClusterProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    updateGameServerCluster(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkUpdateGameServerClusterProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    listGameServerClusters(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listGameServerClustersStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listGameServerClusters.createStream(this.innerApiCalls.listGameServerClusters, request, callSettings);
    }
    /**
    ...
    listGameServerClustersAsync(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listGameServerClusters.asyncIterate(this.innerApiCalls['listGameServerClusters'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.GameServerClustersServiceClient = GameServerClustersServiceClient;
//# sourceMappingURL=game_server_clusters_service_client.js.map