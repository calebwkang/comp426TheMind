...
exports.GameServerConfigsServiceClient = void 0;
const gax = require("google-gax");
const path = require("path");
const gapicConfig = require("./game_server_configs_service_client_config.json");
...
class GameServerConfigsServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listGameServerConfigs: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'gameServerConfigs'),
        };
        ...
        const createGameServerConfigResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.GameServerConfig');
        const createGameServerConfigMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.OperationMetadata');
        const deleteGameServerConfigResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteGameServerConfigMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.OperationMetadata');
        this.descriptors.longrunning = {
            createGameServerConfig: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createGameServerConfigResponse.decode.bind(createGameServerConfigResponse), createGameServerConfigMetadata.decode.bind(createGameServerConfigMetadata)),
            deleteGameServerConfig: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteGameServerConfigResponse.decode.bind(deleteGameServerConfigResponse), deleteGameServerConfigMetadata.decode.bind(deleteGameServerConfigMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.gaming.v1beta.GameServerConfigsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.gameServerConfigsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.gaming.v1beta.GameServerConfigsService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.gaming.v1beta
                    .GameServerConfigsService, this._opts);
        ...
        for (const methodName of gameServerConfigsServiceStubMethods) {
            const callPromise = this.gameServerConfigsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    getGameServerConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    createGameServerConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkCreateGameServerConfigProgress(name) {
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    deleteGameServerConfig(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkDeleteGameServerConfigProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    listGameServerConfigs(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listGameServerConfigsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listGameServerConfigs.createStream(this.innerApiCalls.listGameServerConfigs, request, callSettings);
    }
    /**
    ...
    listGameServerConfigsAsync(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listGameServerConfigs.asyncIterate(this.innerApiCalls['listGameServerConfigs'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.GameServerConfigsServiceClient = GameServerConfigsServiceClient;
//# sourceMappingURL=game_server_configs_service_client.js.map