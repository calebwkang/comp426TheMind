...
exports.GameServerDeploymentsServiceClient = void 0;
const gax = require("google-gax");
const path = require("path");
const gapicConfig = require("./game_server_deployments_service_client_config.json");
...
class GameServerDeploymentsServiceClient {
    ...
    constructor(opts) {
        ...
        this.pathTemplates = {
            gameServerClusterPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/realms/{realm}/gameServerClusters/{cluster}'),
            gameServerConfigPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/gameServerDeployments/{deployment}/configs/{config}'),
            gameServerDeploymentPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/gameServerDeployments/{deployment}'),
            gameServerDeploymentRolloutPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/gameServerDeployments/{deployment}/rollout'),
            realmPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/realms/{realm}'),
        };
        // Some of the methods on this service return "paged" results,
        // (e.g. 50 results at a time, with tokens to get subsequent
        // pages). Denote the keys used for pagination and results.
        this.descriptors.page = {
            listGameServerDeployments: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'gameServerDeployments'),
        };
        ...
        const createGameServerDeploymentResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.GameServerDeployment');
        const createGameServerDeploymentMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.OperationMetadata');
        const deleteGameServerDeploymentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteGameServerDeploymentMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.OperationMetadata');
        const updateGameServerDeploymentResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.GameServerDeployment');
        const updateGameServerDeploymentMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.OperationMetadata');
        const updateGameServerDeploymentRolloutResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.GameServerDeployment');
        const updateGameServerDeploymentRolloutMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.OperationMetadata');
        this.descriptors.longrunning = {
            createGameServerDeployment: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createGameServerDeploymentResponse.decode.bind(createGameServerDeploymentResponse), createGameServerDeploymentMetadata.decode.bind(createGameServerDeploymentMetadata)),
            deleteGameServerDeployment: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteGameServerDeploymentResponse.decode.bind(deleteGameServerDeploymentResponse), deleteGameServerDeploymentMetadata.decode.bind(deleteGameServerDeploymentMetadata)),
            updateGameServerDeployment: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateGameServerDeploymentResponse.decode.bind(updateGameServerDeploymentResponse), updateGameServerDeploymentMetadata.decode.bind(updateGameServerDeploymentMetadata)),
            updateGameServerDeploymentRollout: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateGameServerDeploymentRolloutResponse.decode.bind(updateGameServerDeploymentRolloutResponse), updateGameServerDeploymentRolloutMetadata.decode.bind(updateGameServerDeploymentRolloutMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.gaming.v1beta.GameServerDeploymentsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.gameServerDeploymentsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.gaming.v1beta.GameServerDeploymentsService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.gaming.v1beta
                    .GameServerDeploymentsService, this._opts);
        ...
        for (const methodName of gameServerDeploymentsServiceStubMethods) {
            const callPromise = this.gameServerDeploymentsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    getGameServerDeployment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    getGameServerDeploymentRollout(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    previewGameServerDeploymentRollout(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    fetchDeploymentState(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    createGameServerDeployment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkCreateGameServerDeploymentProgress(name) {
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    deleteGameServerDeployment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkDeleteGameServerDeploymentProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    updateGameServerDeployment(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkUpdateGameServerDeploymentProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    updateGameServerDeploymentRollout(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkUpdateGameServerDeploymentRolloutProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    listGameServerDeployments(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listGameServerDeploymentsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listGameServerDeployments.createStream(this.innerApiCalls.listGameServerDeployments, request, callSettings);
    }
    /**
    ...
    listGameServerDeploymentsAsync(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listGameServerDeployments.asyncIterate(this.innerApiCalls['listGameServerDeployments'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.GameServerDeploymentsServiceClient = GameServerDeploymentsServiceClient;
//# sourceMappingURL=game_server_deployments_service_client.js.map