...
exports.RealmsServiceClient = void 0;
const gax = require("google-gax");
const path = require("path");
const gapicConfig = require("./realms_service_client_config.json");
...
class RealmsServiceClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listRealms: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'realms'),
        };
        ...
        const createRealmResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.Realm');
        const createRealmMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.OperationMetadata');
        const deleteRealmResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteRealmMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.OperationMetadata');
        const updateRealmResponse = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.Realm');
        const updateRealmMetadata = protoFilesRoot.lookup('.google.cloud.gaming.v1beta.OperationMetadata');
        this.descriptors.longrunning = {
            createRealm: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createRealmResponse.decode.bind(createRealmResponse), createRealmMetadata.decode.bind(createRealmMetadata)),
            deleteRealm: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteRealmResponse.decode.bind(deleteRealmResponse), deleteRealmMetadata.decode.bind(deleteRealmMetadata)),
            updateRealm: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateRealmResponse.decode.bind(updateRealmResponse), updateRealmMetadata.decode.bind(updateRealmMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.gaming.v1beta.RealmsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.realmsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.gaming.v1beta.RealmsService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.gaming.v1beta.RealmsService, this._opts);
        ...
        for (const methodName of realmsServiceStubMethods) {
            const callPromise = this.realmsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    getRealm(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    previewRealmUpdate(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    createRealm(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkCreateRealmProgress(name) {
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    deleteRealm(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkDeleteRealmProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    updateRealm(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkUpdateRealmProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    listRealms(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listRealmsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listRealms.createStream(this.innerApiCalls.listRealms, request, callSettings);
    }
    /**
    ...
    listRealmsAsync(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listRealms.asyncIterate(this.innerApiCalls['listRealms'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
exports.RealmsServiceClient = RealmsServiceClient;
//# sourceMappingURL=realms_service_client.js.map